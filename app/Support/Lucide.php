...
/**
 * Inline SVG bodies for the Lucide icons used in the UI.
 *
 * Icons ship as inline SVG rather than a font so they inherit `currentColor`,
 * scale with the type, and cost no extra request. Every path here is a 24x24
 * Lucide glyph drawn with `stroke-width: 2`, round caps and round joins.
 *
 * Add an icon only when a screen actually uses it.
 */
final class Lucide
{
    ...
    private const ICONS = [
        ...
        // Media and chat
        'play' => '<path d="M6 3.5a.7.7 0 0 1 1.05-.607l12.6 7.5a.7.7 0 0 1 0 1.214l-12.6 7.5A.7.7 0 0 1 6 18.5z"/>',
        'pause' => '<rect x="14" y="4" width="4" height="16" rx="1"/><rect x="6" y="4" width="4" height="16" rx="1"/>',
        'mic' => '<path d="M12 19v3"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><rect x="9" y="2" width="6" height="13" rx="3"/>',
        'paperclip' => '<path d="M13.234 20.252 21 12.3a3.53 3.53 0 0 0 0-5 3.53 3.53 0 0 0-5 0L4.575 18.9a5.29 5.29 0 0 0 0 7.5"/>',
        ...
        'volume-off' => '<path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z"/><path d="m17 9 5 5"/><path d="m22 9-5 5"/>',
    ...
    public static function body(string $name): string
    {
        if (! isset(self::ICONS[$name])) {
            throw new InvalidArgumentException("Unknown Lucide icon [{$name}]. Add its path to ".self::class.'.');
        }
